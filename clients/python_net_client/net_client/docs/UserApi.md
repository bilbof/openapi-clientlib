...
with net_client.ApiClient(configuration) as api_client:
    ...
    api_instance = net_client.UserApi(api_client)
    body = net_client.User() # User | Created user object
...
with net_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = net_client.UserApi(api_client)
    body = [net_client.User()] # List[User] | List of user object
...
with net_client.ApiClient(configuration) as api_client:
    ...
    body = net_client.User() # User | Updated user object
