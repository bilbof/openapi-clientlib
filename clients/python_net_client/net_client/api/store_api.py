...
class StoreApi(object):
    ...
    @validate_arguments
    def delete_order(self, order_id : Annotated[conint(strict=True, ge=1), Field(..., description="ID of the order that needs to be deleted")], **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def delete_order_with_http_info(self, order_id : Annotated[conint(strict=True, ge=1), Field(..., description="ID of the order that needs to be deleted")], **kwargs) -> ApiResponse:  # noqa: E501
        """Delete purchase order by ID  # noqa: E501
    ...
    @validate_arguments
    def get_order_by_id(self, order_id : Annotated[conint(strict=True, le=10, ge=1), Field(..., description="ID of pet that needs to be fetched")], **kwargs) -> Order:  # noqa: E501
    ...
    @validate_arguments
    def get_order_by_id_with_http_info(self, order_id : Annotated[conint(strict=True, le=10, ge=1), Field(..., description="ID of pet that needs to be fetched")], **kwargs) -> ApiResponse:  # noqa: E501
        """Find purchase order by ID  # noqa: E501
    ...
    @validate_arguments
    def place_order(self, body : Annotated[Order, Field(..., description="order placed for purchasing the pet")], **kwargs) -> Order:  # noqa: E501
    ...
    @validate_arguments
    def place_order_with_http_info(self, body : Annotated[Order, Field(..., description="order placed for purchasing the pet")], **kwargs) -> ApiResponse:  # noqa: E501
        """Place an order for a pet  # noqa: E501
