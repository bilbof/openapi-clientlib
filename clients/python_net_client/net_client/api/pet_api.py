...
class PetApi(object):
    ...
    @validate_arguments
    def add_pet(self, body : Annotated[Pet, Field(..., description="Pet object that needs to be added to the store")], **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def add_pet_with_http_info(self, body : Annotated[Pet, Field(..., description="Pet object that needs to be added to the store")], **kwargs) -> ApiResponse:  # noqa: E501
        """Add a new pet to the store  # noqa: E501
    ...
    @validate_arguments
    def update_pet(self, body : Annotated[Pet, Field(..., description="Pet object that needs to be added to the store")], **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def update_pet_with_http_info(self, body : Annotated[Pet, Field(..., description="Pet object that needs to be added to the store")], **kwargs) -> ApiResponse:  # noqa: E501
        """Update an existing pet  # noqa: E501
